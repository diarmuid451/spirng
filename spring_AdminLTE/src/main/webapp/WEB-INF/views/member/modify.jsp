			...
			<input type="hidden" name="picture" value="${member.picture }"/>
	        	<div class="register-card-body" >
	                ...
	                <div class="form-group row" >
	                  ...
	                  <div class="col-sm-9">
	                    <input name="id" type="text" readonly class="form-control" value="${member.id }">
	                  </div>
	                </div>
	                ...
	                <div class="form-group row">
	                  ...
	                  <div class="col-sm-9">
	                    <input name="pwd" type="password" class="form-control"  value="${member.pwd }">
	                  </div>
	                </div>
	                <div class="form-group row">
	              ...
	              <div class="card-footer">
	              	<div class="row">
			          	<button type="button" id="modifyBtn" class="btn btn-warning col-s-4 text-center"
